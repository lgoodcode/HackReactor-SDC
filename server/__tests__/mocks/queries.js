...
const skus = [
  ...
  [
    { id: 8, size: 'XS', quantity: 8 },
    { id: 7, size: 'S', quantity: 16 },
    { id: 9, size: 'M', quantity: 17 },
    { id: 10, size: 'L', quantity: 10 },
    { id: 11, size: 'XL', quantity: 15 },
    { id: 12, size: 'XXL', quantity: 6 },
  ],
  [
    { id: 13, size: 'XS', quantity: 8 },
    { id: 14, size: 'S', quantity: 16 },
    { id: 15, size: 'M', quantity: 17 },
    { id: 16, size: 'L', quantity: 10 },
    { id: 17, size: 'XL', quantity: 15 },
    { id: 18, size: 'XXL', quantity: 6 },
  ],
  [
    { id: 19, size: 'XS', quantity: 8 },
    { id: 20, size: 'S', quantity: 16 },
    { id: 21, size: 'M', quantity: 17 },
    { id: 22, size: 'L', quantity: 10 },
    { id: 23, size: 'XL', quantity: 15 },
    { id: 24, size: 'XXL', quantity: 6 },
  ],
  [
    { id: 25, size: 'XS', quantity: 8 },
    { id: 26, size: 'S', quantity: 16 },
    { id: 27, size: 'M', quantity: 17 },
    { id: 28, size: 'L', quantity: 10 },
    { id: 29, size: 'XL', quantity: 15 },
    { id: 30, size: 'XXL', quantity: 6 },
  ],
  [
    { id: 31, size: 'XS', quantity: 8 },
    { id: 32, size: 'S', quantity: 16 },
    { id: 33, size: 'M', quantity: 17 },
    { id: 34, size: 'L', quantity: 10 },
    { id: 35, size: 'XL', quantity: 15 },
    { id: 36, size: 'XXL', quantity: 6 },
  ],
]
